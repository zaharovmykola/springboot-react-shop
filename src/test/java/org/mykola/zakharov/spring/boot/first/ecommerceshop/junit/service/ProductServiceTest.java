...
import org.mykola.zakharov.springboot.react.market.internet.market.service.interfaces.IProductService;
...
public class ProductServiceTest {
    ...
    // полученного инстанцированием из реализованного класса,
    // в поля которого внедряются макеты репозиториев и других зависимостей,
    // если они указаны
    @InjectMocks
